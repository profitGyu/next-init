...
module.exports = {
  extends: ['plugin:@next/next/core-web-vitals', 'plugin:storybook/recommended', 'prettier'],
  plugins: ['@typescript-eslint', '@tanstack/query', 'import', 'jsx-a11y', 'react', 'react-hooks', '@next/next'],
  rules: {
